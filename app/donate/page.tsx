      ...
      <section className="py-20 bg-dark-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-dark-200 rounded-full p-1 border border-white/10 inline-flex">
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
                  ...
                  <div className="absolute inset-0 bg-black/80 backdrop-blur-sm rounded-2xl z-20 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                        ...
                        <span className="text-white/60 text-sm">Launching in 2 weeks</span>
                      </div>
                    </div>
                  </div>

                  {/* Disabled Form */}
                  <div className="bg-dark-200 rounded-2xl p-8 border border-white/10 opacity-50">
                    <h2 className="text-2xl font-bold text-white mb-6">Choose an amount</h2>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                      {donateAmounts.map((amount) => (
                        <button
                          key={amount}
                          disabled
                          className={`py-3 rounded-xl font-semibold bg-white/10 text-white/40 cursor-not-allowed`}
                        >
                    ...
                    <div className="mb-6">
                      <input
                        ...
                        disabled
                        className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white/40 placeholder-white/30 cursor-not-allowed"
                      />
                    </div>

                    <div className="flex gap-3 mb-6">
                      <button disabled className="flex-1 bg-white/10 text-white/40 py-3 rounded-xl font-semibold cursor-not-allowed">
                        One-time
                      </button>
                      <button disabled className="flex-1 bg-white/10 text-white/40 py-3 rounded-xl font-semibold cursor-not-allowed">
                        Monthly
                    ...
                    <button disabled className="w-full bg-white/10 text-white/40 py-4 rounded-xl font-bold text-lg cursor-not-allowed flex items-center justify-center gap-2">
              ...
              {activeTab === 'bank' && (
                <div className="bg-dark-200 rounded-2xl p-8 border border-white/10">
                  ...
                  <div className="bg-white/5 rounded-xl p-6 border border-white/10 mb-6">
                    <div className="space-y-4">
                      <div className="flex justify-between items-center pb-2 border-b border-white/10">
                        <span className="text-white/40 text-sm">Bank Name</span>
                      ...
                      <div className="flex justify-between items-center pb-2 border-b border-white/10">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-white font-semibold text-xl tracking-wider">{bankDetails.accountNumber}</span>
                          <button
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-white/40 text-sm">Sort Code</span>
                        <span className="text-white font-semibold">{bankDetails.sortCode}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <Link
                    href="/contact"
                    className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-green-500/30 transform hover:scale-105 flex items-center justify-center gap-2"
                  >
            ...
            <div>
              <div className="bg-gradient-to-br from-primary-500/10 to-pink-500/10 rounded-2xl p-6 border border-white/10 mb-6">
                <Gift className="w-10 h-10 text-primary-400 mb-3" />
                <h3 className="text-white font-bold text-lg mb-2">Your Impact</h3>
                <p className="text-white/50 text-sm mb-4">Every donation directly helps children and families in need.</p>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-white/40 text-sm">₦5,000</span>
                    <span className="text-white text-sm">Essential medication</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/40 text-sm">₦20,000</span>
                    <span className="text-white text-sm">One treatment session</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/40 text-sm">₦50,000+</span>
                    <span className="text-white text-sm">Critical hospital care</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                ...
                <h3 className="text-white font-bold text-lg mb-2">100% Transparency</h3>
                <p className="text-white/50 text-sm mb-3">We are fully accountable for every naira entrusted to us.</p>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/40 text-xs">Registered Nigerian Nonprofit</span>
                </div>
              </div>
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 mt-6">
                ...
                <p className="text-white/40 text-sm mb-3">Call us or send an email for assistance</p>
                <div className="space-y-2">
                  <p className="text-white/60 text-sm">📞 +234 800 000 0000</p>
                  <p className="text-white/60 text-sm">✉️ info@childhoodcancerfoundation.org</p>
                </div>
              </div>
            </div>
          </div>
