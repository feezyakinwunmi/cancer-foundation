...
imageUrl="https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1600&h=900&fit=crop"
      ...
      <section className="py-20 bg-dark-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {type.benefits.map(benefit => (
                        <span key={benefit} className="text-xs text-white/40 bg-white/5 px-2 py-1 rounded-full">✓ {benefit}</span>
                      ))}
                    </div>
                  </div>
                </div>
          ...
          {/* Current Partners */}
          <div className="bg-gradient-to-r from-primary-500/10 to-pink-500/10 rounded-2xl p-8 border border-white/10 mb-12 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Our Current Partners</h3>
            <div className="flex flex-wrap justify-center gap-8">
              {[1, 2, 3, 4, 5].map(i => (
                <div key={i} className="bg-white/5 rounded-xl px-6 py-3 border border-white/10">
                  <span className="text-white/40 text-sm">Partner {i}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-dark-200 rounded-2xl p-8 border border-white/10">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Become a Partner</h3>
              <form className="space-y-4">
                <div>
                  <label className="block text-white/60 text-sm mb-2">Organization Name</label>
                  <input type="text" className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary-500" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="email" className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary-500" />
                  </div>
                  <div>
                    <label className="block text-white/60 text-sm mb-2">Phone</label>
                    <input type="tel" className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary-500" />
                  </div>
                </div>
                <div>
                  <label className="block text-white/60 text-sm mb-2">Partnership Interest</label>
                  <select className="w-full text-black bg-white/10 border border-white/20 rounded-xl px-4 py-3  focus:outline-none focus:border-primary-500">
